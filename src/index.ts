...
async function bootstrap() {
  ...
  const fairValueCompareHandler = require(path.join(__dirname, '../api/fair-value-compare.js'));
  app.get('/api/fair-value-compare', (req, res) => {
    fairValueCompareHandler(req, res);
  });

  const priceCompareHandler = require(path.join(__dirname, '../api/price-compare.js'));
