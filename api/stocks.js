...
/**
 * Fetches live EGX stock data from TradingView scanner API
 */
...
/**
 * Calculates fair value for a stock using PE ratio or Fibonacci-based method
 */
...
/**
 * Calculates buy/sell signal based on technical indicators
 */
function calculateSignal(stock, fairValue, fairValueUpsidePercent) {
  const reasons = [];
  const price = stock.currentPrice;

  // Valuation score (weight: 0.30)
  ...
  // Trend score (SMA20 vs SMA50) (weight: 0.25)
