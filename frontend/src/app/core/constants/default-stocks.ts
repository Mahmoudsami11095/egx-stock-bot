...
export const DEFAULT_STOCKS: StockAnalysisResult[] = [
  {
    quote: { symbol: 'MPCI', nameEn: 'Memphis Pharma', nameAr: 'ممفيس للأدوية والصناعات الكيماوية', currentPrice: 290.00, previousClose: 293.90, change: -3.90, changePercent: -1.36, dayHigh: 295.90, dayLow: 287.00, fiftyTwoWeekHigh: 298.90, fiftyTwoWeekLow: 90.60, volume: 431879, avgVolume: 421084, peRatio: 12.73, dividendYield: 4.15, dividendPerShare: 12.04 },
  ...
  {
    quote: { symbol: 'ETEL', nameEn: 'Telecom Egypt', nameAr: 'المصرية للاتصالات', currentPrice: 103.60, previousClose: 106.80, change: -3.20, changePercent: -3.00, dayHigh: 107.09, dayLow: 102.75, fiftyTwoWeekHigh: 112.98, fiftyTwoWeekLow: 40.40, volume: 1511598, avgVolume: 827267, peRatio: 7.84, dividendYield: 1.35, dividendPerShare: 1.40 },
  ...
  {
    quote: { symbol: 'ORAS', nameEn: 'Orascom Construction', nameAr: 'أوراسكوم كونستراكشون', currentPrice: 712.20, previousClose: 717.90, change: -5.70, changePercent: -0.79, dayHigh: 719.50, dayLow: 702.00, fiftyTwoWeekHigh: 812.50, fiftyTwoWeekLow: 377.00, volume: 193879, avgVolume: 278667, peRatio: 6.32, dividendYield: 3.23, dividendPerShare: 23.00 },
  ...
  {
    quote: { symbol: 'SWDY', nameEn: 'Elsewedy Electric', nameAr: 'السويدى إليكتريك', currentPrice: 93.00, previousClose: 94.95, change: -1.95, changePercent: -2.05, dayHigh: 94.95, dayLow: 91.80, fiftyTwoWeekHigh: 97.50, fiftyTwoWeekLow: 62.00, volume: 270010, avgVolume: 210912, peRatio: 9.80, dividendYield: 1.76, dividendPerShare: 1.64 },
  ...
  {
    quote: { symbol: 'ABUK', nameEn: 'Abu Qir Fertilizers', nameAr: 'أبوقير للأسمدة والصناعات الكيماوية', currentPrice: 73.00, previousClose: 71.30, change: 1.70, changePercent: 2.36, dayHigh: 73.29, dayLow: 70.90, fiftyTwoWeekHigh: 95.00, fiftyTwoWeekLow: 45.18, volume: 2221116, avgVolume: 2138356, peRatio: 8.50, dividendYield: 6.22, dividendPerShare: 4.54 },
  ...
  {
    quote: { symbol: 'TMGH', nameEn: 'Talaat Moustafa Group', nameAr: 'مجموعة طلعت مصطفى القابضة', currentPrice: 97.30, previousClose: 97.60, change: -0.30, changePercent: -0.30, dayHigh: 97.89, dayLow: 95.20, fiftyTwoWeekHigh: 103.87, fiftyTwoWeekLow: 52.25, volume: 3985718, avgVolume: 4220528, peRatio: 13.71, dividendYield: 0.30, dividendPerShare: 0.29 },
  ...
  {
    quote: { symbol: 'JUFO', nameEn: 'Juhayna Food Industries', nameAr: 'جهينة للصناعات الغذائية', currentPrice: 28.67, previousClose: 28.72, change: -0.05, changePercent: -0.17, dayHigh: 28.83, dayLow: 28.48, fiftyTwoWeekHigh: 32.30, fiftyTwoWeekLow: 20.27, volume: 718576, avgVolume: 862228, peRatio: 20.67, dividendYield: 1.19, dividendPerShare: 0.34 },
  ...
  {
    quote: { symbol: 'AMOC', nameEn: 'Alexandria Mineral Oils', nameAr: 'الإسكندرية للزيوت المعدنية', currentPrice: 8.91, previousClose: 8.33, change: 0.58, changePercent: 6.96, dayHigh: 9.04, dayLow: 8.33, fiftyTwoWeekHigh: 9.85, fiftyTwoWeekLow: 6.66, volume: 44465398, avgVolume: 7881923, peRatio: 8.12, dividendYield: 4.35, dividendPerShare: 0.39 },
  ...
  {
    quote: { symbol: 'HELI', nameEn: 'Heliopolis Housing', nameAr: 'مصر الجديدة للإسكان والتعمير', currentPrice: 8.20, previousClose: 8.41, change: -0.21, changePercent: -2.50, dayHigh: 8.60, dayLow: 8.19, fiftyTwoWeekHigh: 8.60, fiftyTwoWeekLow: 3.11, volume: 28689142, avgVolume: 23613019, peRatio: 9.10, dividendYield: 5.39, dividendPerShare: 0.44 },
  ...
  {
    quote: { symbol: 'ISPH', nameEn: 'Ibn Sina Pharma', nameAr: 'ابن سينا فارما', currentPrice: 3.85, previousClose: 3.80, change: 0.05, changePercent: 1.32, dayHigh: 3.90, dayLow: 3.75, fiftyTwoWeekHigh: 4.20, fiftyTwoWeekLow: 2.10, volume: 5420100, avgVolume: 4800000, peRatio: 11.20, dividendYield: 0.99, dividendPerShare: 0.04 },
