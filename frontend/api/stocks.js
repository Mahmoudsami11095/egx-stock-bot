...
const STOCK_ARABIC_NAMES = {
  ...
  'COPO': 'العامة لمنتجات الخزف والصيني - شيني',
  'BINV': 'بي إنفستمنتس القابضة',
  'MASR': 'مدينة مصر',
  'CCRS': 'القاهرة للزيوت والصابون',
  'DOMT': 'الصناعات الغذائية العربية - دومتي',
  'OBOUR': 'العبور للاستثمار العقاري',
  'CINV': 'سيتي للتحاليل الطبية',
  ...
  'GOUR': 'جورميه إيجيبت',
  'ACGC': 'عربية حجيج للقطن',
  'AFMC': 'الإسكندرية للغزل والنسيج',
  'AIND': 'العربية للاستثمارات والتنمية',
  'AIFP': 'العربية للصناعات الهندسية',
  'AJWA': 'أجواء للصناعات الغذائية',
  'ALCN': 'الإسكندرية لتداول الحاويات',
  'ALEX': 'الإسكندرية الوطنية للمقاولات',
  'APEX': 'أبيكس فارما',
  'ARAB': 'عربية أصول للاستثمار',
  'ASCM': 'أسيك للتعدين - أسكوم',
  'ATLC': 'التوفيق للتأجير التمويلى - أية تى ليز',
  'BCOM': 'بنك البركة مصر',
  'BCAP': 'بلتون القابضة',
  'BERP': 'بي انفستمنتس',
  'BTFH': 'بايونيرز بروبرتيز للتمويل',
  'CERA': 'سيراميكا ريماس',
  'CICH': 'سي آي كابيتال القابضة',
  'CNTE': 'القاهرة للإسكان والتعمير',
  'DCTC': 'الدلتا للإنشاء والتعمير',
  'DSCW': 'دايس للملابس الجاهزة',
  'DSHP': 'الداي للتنمية والاستثمار',
  'EDBM': 'البنك المصري لتنمية الصادرات',
  'EGCH': 'مصر لصناعة الكيماويات',
  'EGDY': 'السويدي القابضة',
  'EGTS': 'المنتجعات السياحية المصرية',
  'ELKA': 'القاهرة للاستثمار والتنمية العقارية - سيرا',
  'ELSH': 'الشمس للإسكان والتعمير',
  'ELWA': 'الوادي للاستثمار السياحي',
  'EPCO': 'مصر للزيوت والصابون',
  'EQPT': 'المصرية للمشروعات السياحية - أمريكانا',
  'FEWA': 'فيرتيكا للصناعات',
  'FIFI': 'فيصل الإسلامي المصري',
  'GTHE': 'جلوبر تليكوم',
  'HEAT': 'مطاحن ومخابز شمال القاهرة',
  'IFAP': 'الأهرام للطباعة والتغليف',
  'ISMA': 'الإسماعيلية مصر للدواجن',
  'KABO': 'النصر للملابس والمنسوجات - كابو',
  'KRDI': 'كريدي أجريكول',
  'LCSH': 'القلعة للاستثمارات المالية',
  'MAHM': 'مطاحن ومخابز الإسكندرية',
  'MBSC': 'مطاحن ومخابز شرق الدلتا',
  'MEFM': 'مطاحن ومخابز وسط وغرب الدلتا',
  'MOIL': 'مرسى مرسى علم للتنمية السياحية',
  'MPCO': 'المصرية للنشا والجلوكوز',
  'NAHO': 'نعيم القابضة للاستثمارات',
  'NCCW': 'النصر للأعمال المدنية',
  'ODCI': 'أوراسكوم للاستثمار',
  'PACH': 'البويات والصناعات الكيماوية - باكين',
  'PIOH': 'بايرونيرز القابضة',
  'PORT': 'بورتو جروب',
  'RTOB': 'الرواد للسياحة',
  'SASP': 'سماد مصر - إيجيفرت',
  'SCEM': 'أسمنت سيناء',
  'SDTI': 'جنوب الوادي للأسمنت',
  'SPMD': 'سبيد ميديكال',
  'SUCE': 'السويس للأسمنت',
  'TALM': 'تعليم لخدمات الإدارة',
  'UEGC': 'الصعيد العامة للمقاولات',
  'VALO': 'فالدا للاستثمار',
  'VERT': 'فيرتكا للحلول',
  'WCDF': 'مطاحن ومخابز وسط الدلتا',
